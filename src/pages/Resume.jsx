      ...
      >
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            ...
            <li style={{ marginTop: 8 }}>
              ...
              <span style={{ color: "#aaa" }}>Percentage: 84.8%</span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>10th Board — Shyampahari Sri Ramkrishna Sishapith</strong> (West Bengal Board, 2023)
              <br />
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            ...
            <li>3️⃣ SGC Movie Downloader (In Progress)</li>
        ...
        >
          {[
            { name: "🏆 LeetCode", link: "https://leetcode.com/u/Sayanmondal835/" },
            { name: "💻 GitHub", link: "https://github.com/Sayanmondal755089" },
            { name: "💼 LinkedIn", link: "https://www.linkedin.com/in/sayan-mondal78/" },
          ].map((site) => (
            <motion.a
              key={site.name}
              href={site.link}
